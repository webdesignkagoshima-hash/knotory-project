          ...
          <div class="p-global-nav__menu">
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#announcement" class="global-nav__link" id="nav-announcement">ふたりからのご報告</a>
              </h2>
              <p class="p-global-nav__subTitle">announcement</p>
            </hgroup>
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#about-us" class="global-nav__link" id="nav-about">私たちについて</a>
              </h2>
              <p class="p-global-nav__subTitle">about us</p>
            </hgroup>
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#our-story" class="global-nav__link" id="nav-story">ふたりの物語</a>
              </h2>
              <p class="p-global-nav__subTitle">our story</p>
            </hgroup>
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#qa-with-us" class="global-nav__link" id="nav-qa">ふたりに聞いてみました</a>
              </h2>
              <p class="p-global-nav__subTitle">q&amp;a with us</p>
            </hgroup>
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#memories" class="global-nav__link" id="nav-memories">思い出のアルバム</a>
              </h2>
              <p class="p-global-nav__subTitle">memories</p>
            </hgroup>
            <hgroup class="p-global-nav__item">
              <h2 class="p-global-nav__title">
                <a href="#gratitude" class="global-nav__link" id="nav-gratitude">心からのメッセージ</a>
              </h2>
  ...
  <main class="l-main">
    ...
    <div class="p-fv">
      <div class="p-fv__container">
        <!-- メインキャッチコピーを入力してください -->
        <p class="p-fv__copy js-fv__copy">We Tied the Knot</p>
        <!-- 新郎新婦の名前（英語表記）を入力してください -->
        <p class="p-fv__byline js-fadeIn">By Naoto&Yuna</p>
      </div>
      ...
      <div class="p-announcement__container">
        ...
        <div class="p-announcement__content js-fadeIn">
          ...
          <p>
            ...
            <br>
            まだまだ未熟なふたりではありますが、<br>
            これからの毎日を支え合い、励まし合いながら<br>
    ...
    <section class="p-aboutUs">
      <div class="p-aboutUs__container">
        ...
        <div class="p-aboutUs__profileWrapper">
          <article class="c-profile js-fadeIn">
            <figure class="c-profile__image c-profile__image__groom">
            ...
            <div class="c-profile__content">
              ...
              <p>
                ...
                <br>
                昔から体を動かすことが好きです。<br>
                休日は趣味で、歴史ある町並みを散歩したり<br>
                神社巡りをしています。
              </p>
            </div>
          </article>
          <article class="c-profile js-fadeIn">
            <figure class="c-profile__image c-profile__image__bride">
    ...
    <section class="p-ourStory">
      ...
      <div class="p-ourStory__container">
        <div class="p-ourStory__content">
          <section class="p-ourStory__contentItem">
            <h3 class="c-ourStoryTitle">
              birthday
              
            </h3>
    
            <div class="p-ourStory__contentItemInner">
              <!-- 左寄せ：left / 右寄せ：right / 真ん中寄せ：center -->
              <article class="c-ourStoryCard js-anime" data-position="left">
                <div class="c-ourStoryCard__container">
                  ...
                  <div class="c-ourStoryCard__textWrapper">
                    ...
                    <p class="c-ourStoryCard__text">
                      1995年9月25日誕生<br>石川県生まれ O型<br>吉岡家の次男としてのびのびと<br>成長する。
                    </p>
                  </div>
                </div>
              </article>
              ...
              <!-- 左寄せ：left / 右寄せ：right / 真ん中寄せ：center -->
              <article class="c-ourStoryCard js-anime" data-position="right">
                <div class="c-ourStoryCard__container">
                  <!-- 年号を入力してください -->
                  ...
                  <div class="c-ourStoryCard__textWrapper">
                    <!-- テキストを入力してください -->
                    <p class="c-ourStoryCard__text">
                      1998年2月10日誕生<br>東京都生まれ O型<br>花村家の長女として、やさしく<br>朗らかに育ちました。
                    </p>
                  </div>
                </div>
              </article>
          ...
          <section class="p-ourStory__contentItem">
            <h3 class="c-ourStoryTitle">
              growth
              <span class="c-ourStoryTitle__numbering">01</span>
            </h3>
          ...
          <section class="p-ourStory__contentItem">
            <h3 class="c-ourStoryTitle">
              growth
              <span class="c-ourStoryTitle__numbering">02</span>
            </h3>
          ...
          <section class="p-ourStory__contentItem">
            ...
            <div class="p-ourStory__contentItemInner">
              <!-- 左寄せ：left / 右寄せ：right / 真ん中寄せ：center -->
              <article class="c-ourStoryCard js-anime" data-position="center">
                <div class="c-ourStoryCard__container">
                  <!-- 年号を入力してください -->
        ...
        <div class="p-ourStory__image js-fadeIn">
          <figure>
            <img src="./assets/images/figure-just-married.png" alt="Just Married">
          </figure>
        </div>
      </div>
    </section>
    ...
    <section class="p-memories">
      <div class="p-memories__container">
        ...
        <div class="p-memories__content">
          ...
          <div class="p-memories__slider splide js-fadeIn">
          ...
          <!-- videoタグでMP4データを埋め込み -->
          <div class="p-memories__video js-fadeIn">
            <div class="p-memories__videoWrapper">
              ...
              <button class="p-memories__playButton" aria-label="動画を再生">
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none">
                  ...
                  <path d="M25 20L40 30L25 40V20Z" fill="#ABC1C6"/>
                </svg>
              </button>
            </div>
            <!-- 動画のキャプションを入力してください -->
        ...
        <div class="p-comments__content">
          ...
          <form id="commentForm" class="p-comments__form">
            ...
            <div class="p-comments__submit">
              <button type="submit" class="p-comments__button" id="submitBtn">
                この内容で送る
              </button>
            </div>
            ...
            <!-- 送信完了モーダル -->
            <div id="successModal" class="p-comments__modal">
              <div class="p-comments__modal-content">
                <p class="p-comments__modal-text">
                  <img src="./assets/images/cracker.png" alt="クラッカー" class="p-comments__modal-text-icon">
                  送信が無事完了しました！
                </p>
                <button id="closeModal" class="p-comments__modal-close">閉じる×</button>
              </div>
            </div>
          </form>
        </div>
    ...
    .p-comments__input:focus,
    .p-comments__textarea:focus {
      outline: none;
      border-color: #AF9B4F;
    }
    
    .p-comments__input::placeholder,
    .p-comments__textarea::placeholder {
      color: #ccc;
      font-family: 'Shippori Mincho', serif;
    }
    ...
    .p-comments__button::after {
      ...
      background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='%23AF9B4F' viewBox='0 0 24 24'%3e%3cpath d='M8.59 16.58L13.17 12L8.59 7.41L10 6l6 6-6 6-1.41-1.42z'/%3e%3c/svg%3e");
      background-size: 14px 14px;
      background-repeat: no-repeat;
      background-position: center;
    }
    
    .p-comments__button:hover {
      background-color: #9a8845;
      transform: translateY(-2px);
      box-shadow: 0 4px 12px rgba(175, 155, 79, 0.3);
    }
    
    .p-comments__button:disabled {
    ...
    .p-comments__message.success {
      background-color: #e8f5e8;
      color: #2e7d32;
      border: 1px solid #c8e6c9;
    }
    
    .p-comments__message.error {
    ...
    .p-comments__modal.show {
      display: flex;
    }
    
    .p-comments__modal-content {
      padding: 40px 30px;
      border-radius: 12px;
      text-align: center;
      max-width: 350px;
    ...
    .p-comments__modal-icon {
      width: 80px;
      height: 80px;
      margin: 0 auto 20px;
    }
    
    .p-comments__modal-icon img {
      width: 100%;
      height: 100%;
      object-fit: contain;
    }
    
    .p-comments__modal-text {
      display: flex;
      align-items: center;
      justify-content: center;
      gap: 10px;
    ...
    .p-comments__modal-text-icon {
      width: 48px;
      height: 48px;
      object-fit: contain;
    }
    
    .p-comments__modal-close {
      background: none;
      color: #fff;
      padding: 12px 24px;
      border: none;
    ...
    document.getElementById('commentForm').addEventListener('submit', async function(e) {
      ...
      try {
        const response = await fetch('comment_handler.php', {
          method: 'POST',
          headers: {
        ...
        messageDiv.textContent = '送信に失敗しました: ' + error.message;
        messageDiv.className = 'p-comments__message error';
